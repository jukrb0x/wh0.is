...
export const Pre = ({
    ...
    return (
        <div className="nextra-code-block relative mt-6 first:mt-0">
            {filename && (
                <div className="absolute top-0 z-[1] w-full truncate rounded-t-xl bg-blue-700/5 py-2 px-4 text-xs text-gray-700 dark:bg-blue-300/10 dark:text-gray-200">
                    {filename}
                </div>
            )}
            <pre
                className={[
                    'bg-blue-700/5 mb-4 overflow-x-auto rounded-xl font-medium subpixel-antialiased dark:bg-blue-300/10 text-[.9em]',
                    'contrast-more:border contrast-more:border-blue-900/20 contrast-more:contrast-150 contrast-more:dark:border-blue-100/40',
